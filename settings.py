# Django settings for CalcWorks project.
from os.path import join, dirname

PROJECT_HOME =dirname(__file__)
DEBUG = True
...
SECRET_KEY = 'd$+ly$%*v9(4p8qsypdz8x=r&s4e#v5pcp1=@%m018q%qm%8a9'
...
ROOT_URLCONF = 'CalcWorks.urls'

TEMPLATE_DIRS = (
    join(PROJECT_HOME, 'templates'),
)
